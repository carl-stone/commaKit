...
`commaData` extends `RangedSummarizedExperiment` and is constructed from per-sample
methylation files:
...
**Multiple Modification Types** vignette (`vignette("multiple-modification-types", package = "commaKit")`).
...
- **Getting Started** (`vignette("getting-started", package = "commaKit")`) —
...
- **Understanding commaData**
  ...
  `RangedSummarizedExperiment` container, assays, site metadata, and result
  layers.
- **Import Troubleshooting**
  (`vignette("import-troubleshooting", package = "commaKit")`) — practical
  guidance for modkit, Dorado, Megalodon, genome, and annotation inputs.
- **Multiple Modification Types**
  (`vignette("multiple-modification-types", package = "commaKit")`) — joint 6mA
