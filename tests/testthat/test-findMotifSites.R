...
test_that(
  paste(
    "findMotifSites() finds the correct position for a single",
    "palindromic motif hit"
  ),
  {
    skip_if_not_installed("Biostrings")
...
test_that(
  paste(
    "findMotifSites() reports identical positions on both strands",
    "for a palindrome"
  ),
  {
    skip_if_not_installed("Biostrings")
...
test_that(
  paste(
    "findMotifSites() finds two palindromic hits in a sequence",
...
test_that(
  paste(
    "findMotifSites() finds the reverse-complement of a",
    "non-palindromic motif on the - strand"
  ),
  {
    skip_if_not_installed("Biostrings")
